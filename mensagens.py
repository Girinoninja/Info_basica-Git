...
def quem_e():
    ...
    def contribuicoes():
        mensagem1 = ("Ada passou a ser conhecida como Ada Lovelace quando herdou o título de seus antepassados,"
                ...
                'O artigo é mais famoso pelo apêndice final, Nota G. Ele demonstra a operação da máquina dando o exemplo do cálculo dos chamados'
                'números de Bernoulli, que surgem em muitos lugares na matemática moderna. Os números de Bernoulli são particularmente passíveis de cálculo de máquina porque são definidos recursivamente:   '
                ' podemos usar o primeiro para determinar o segundo, o segundo para o terceiro, e assim por diante. Existem várias maneiras diferentes de calcular esses números, e Lovelace não escolheu a mais simples:  '
                'ela observou, em vez disso, que o "objeto não é simplicidade ou facilidade de computação')
    return mensagem
